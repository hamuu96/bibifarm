...
//produce insertion
$insert_onion = "INSERT  INTO  `PRODUCE` (produceID, produceName, price, produceDescription,img)
...
//insert tomatoes
$insert_tomatoes = "INSERT  INTO  `PRODUCE` (produceID, produceName, price, produceDescription,img)
...
//insert tomatoes
$insert_green = "INSERT  INTO  `PRODUCE` (produceID, produceName, price, produceDescription,img)
...
//insert tomatoes
$insert_water = "INSERT  INTO  `PRODUCE` (produceID, produceName, price, produceDescription,img)
...
//insert tomatoes
$insert_pepers = "INSERT  INTO  `PRODUCE` (produceID, produceName, price, produceDescription,img)
...
//insert tomatoes
$insert_avacado = "INSERT  INTO  `PRODUCE` (produceID, produceName, price, produceDescription,img)
...
if(!$exec_iProduce  and !$exec_tomatoes and !$exec_green and !$insert_water and !$insert_pepers and  !$insert_avacado  and   !mysqli_query($conn, $create_produce) ){
